...
def yolo_loss(args, anchors, num_classes, ignore_thresh=.5, label_smoothing=0.1, print_loss=False, normalize=True):
    ...
    #   y_true是一个列表，包含三个特征层，shape分别为(m,13,13,3,33),(m,26,26,3,33),(m,52,52,3,33)。
    #   yolo_outputs是一个列表，包含三个特征层，shape分别为(m,13,13,3,33),(m,26,26,3,33),(m,52,52,3,33)。
    ...
    for l in range(num_layers):
        ...
        # 其中：
        # grid        (13,13,1,2) 网格坐标
        # raw_pred    (m,13,13,3,33) 尚未处理的预测结果
